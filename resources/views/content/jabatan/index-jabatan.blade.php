...
@section('title','JABATAN  | Dasboard')
<body>
    <style>
        .table {
            text-align: center;
                ...
                <section class="content">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container mt-3">
                                <a href="{{route('jabatan.create')}}"><button class="btn btn-primary">Tambah Data</button></a>
                                        ...
                                        <tbody>
                                            @foreach ($data as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <a href="{{ route('status.edit', $d->id) }}"><button class="btn btn-info">EDIT</button></a> --}}
